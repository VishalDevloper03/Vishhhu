...
# ========== CONFIGURATION ==========
TOKEN = '8545477292:AAFXMQJ6KXLdqIYrK_kVtsD1S63ujDi73qg'
OWNER_ID = 8000588677
ADMIN_ID = 8000588677
...
GROQ_API_KEY = "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"
...
if __name__ == '__main__':
    logger.info("=" * 40 + "\n🚀 ᴀᴛx ʙᴏᴛ ʜᴏꜱᴛ 3.0 ꜱᴛᴀʀᴛɪɴɢ...\n" + 
                f"🔧 ᴘʏᴛʜᴏɴ: {sys.version.split()[0]}\n" +
                f"📂 ʙᴀꜱᴇ ᴅɪʀ: {BASE_DIR}\n📁 ᴜᴘʟᴏᴀᴅ ᴅɪʀ: {UPLOAD_BOTS_DIR}\n" +
                f"🗄️ ᴅᴀᴛᴀ ᴅɪʀ: {IROTECH_DIR}\n👑 ᴏᴡɴᴇʀ ɪᴅ: {OWNER_ID}\n🛡️ ᴀᴅᴍɪɴꜱ: {len(admin_ids)}\n" +
                f"🤖 ᴀɪ ᴀꜱꜱɪꜱᴛᴀɴᴛ: {'✅ ᴇɴᴀʙʟᴇᴅ' if groq_client else '❌ ᴅɪꜱᴀʙʟᴇᴅ'}\n" +
                f"🗃️ ᴍᴏɴɢᴏᴅʙ: {'✅ ᴄᴏɴɴᴇᴄᴛᴇᴅ' if mongo_client else '❌ ᴅɪꜱᴄᴏɴɴᴇᴄᴛᴇᴅ'}\n" + "=" * 40)
    
    # Update all existing users to MongoDB
    if mongo_users is not None:
        try:
            user_count = 0
            for user_id in active_users:
                ...
                if save_user_to_mongo(user_data):
                    user_count += 1
            logger.info(f"ᴜᴘᴅᴀᴛᴇᴅ {user_count} ᴜꜱᴇʀꜱ ᴛᴏ ᴍᴏɴɢᴏᴅʙ.")
        except Exception as e:
            logger.error(f"ᴇʀʀᴏʀ ᴜᴘᴅᴀᴛɪɴɢ ᴜꜱᴇʀꜱ ᴛᴏ ᴍᴏɴɢᴏᴅʙ: {e}")
    
    # Start Flask keep-alive
    keep_alive()
    
    logger.info("🔄 ꜱᴛᴀʀᴛɪɴɢ ʙᴏᴛ ᴘᴏʟʟɪɴɢ...")
    ...
    while True:
        try:
            ...
            logger.warning("ᴘᴏʟʟɪɴɢ ᴛɪᴍᴇᴏᴜᴛ. ʀᴇꜱᴛᴀʀᴛɪɴɢ ɪɴ 5ꜱ...")
            time.sleep(5)
        except requests.exceptions.ConnectionError as ce:
            logger.error(f"ᴘᴏʟʟɪɴɢ ᴄᴏɴɴᴇᴄᴛɪᴏɴ ᴇʀʀᴏʀ: {ce}. ʀᴇᴛʀʏɪɴɢ ɪɴ 15ꜱ...")
            time.sleep(15)
        except telebot.apihelper.ApiException as ae:
            logger.error(f"ᴛᴇʟᴇɢʀᴀᴍ ᴀᴘɪ ᴇʀʀᴏʀ: {ae}. ʀᴇᴛʀʏɪɴɢ ɪɴ 30ꜱ...")
            time.sleep(30)
        except Exception as e:
            logger.critical(f"❌ ᴜɴᴇxᴘᴇᴄᴛᴇᴅ ᴘᴏʟʟɪɴɢ ᴇʀʀᴏʀ: {e}", exc_info=True)
            logger.info("ʀᴇꜱᴛᴀʀᴛɪɴɢ ʙᴏᴛ ᴘᴏʟʟɪɴɢ ɪɴ 60ꜱ...")
            time.sleep(60)